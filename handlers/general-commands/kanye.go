...
func Kanye(s *discordgo.Session, m *discordgo.MessageCreate) {
	KanyeLines := []string{
		...
		"```\nonce again I am being attacked for presenting new ideas``` - Kanye West on Twitter",
		"```\nMan ... ninjas are kind of cool ... I just don't know any personally``` - Kanye West on Twitter",
		"```\nMy memories are from the future``` - Kanye West on Twitter",
		"```\nThere's so many lonely emojis man``` - Kanye West on Twitter",
		...
		"```\nI leave my emojis bart Simpson color``` - Kanye West on Twitter",
		...
		"```\nHave you ever thought you were in love with someone but then realized you were just staring in a mirror for 20 minutes?``` - Kanye West on Twitter",
		...
		"```\nIt's 1 am and I can't stop thinking about myself.``` - Kanye West on Twitter",
		...
		"```\nWell, I guess a blowjob's better than no job``` - Kanye West on 30 Hours",
